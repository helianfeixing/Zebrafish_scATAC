...
```{python}
np.savetxt("/home/zhangyl/zbf_scATAC_v3/RDS/W_atac_merge.txt" , W , delimiter=",")
np.savetxt("/home/zhangyl/zbf_scATAC_v3/RDS/H_atac_merge.txt" , H , delimiter=",")
```
...
```{r}
W_merge <- fread(file = "~/zbf_scATAC_v3/RDS/W_atac_merge.txt" ,header = F)
H_merge <- fread(file = "~/zbf_scATAC_v3/RDS/H_atac_merge.txt" ,header = F)
...
```{r}
atac_merge <- readRDS(file = "~/zbf_scATAC_n/atac_merge.RDS")
...
write.table(as.data.frame(top_peaks_module2) , file = "zbf_scATAC_v3/to_do/increase_module_2.bed" , quote = F , sep = "\t" , row.names = F)
write.table(as.data.frame(top_peaks_module3) , file = "zbf_scATAC_v3/to_do/increase_module_3.bed" , quote = F , sep = "\t" , row.names = F)
write.table(as.data.frame(top_peaks_module4) , file = "zbf_scATAC_v3/to_do/increase_module_4.bed" , quote = F , sep = "\t" , row.names = F)
write.table(as.data.frame(top_peaks_module6) , file = "zbf_scATAC_v3/to_do/increase_module_6.bed" , quote = F , sep = "\t" , row.names = F)
write.table(as.data.frame(top_peaks_module10) , file = "zbf_scATAC_v3/to_do/increase_module_10.bed" , quote = F , sep = "\t" , row.names = F)
```
...
write.table(as.data.frame(random_peaks) , file = "zbf_scATAC_v3/to_do/random_2000_peaks.bed" , quote = F , sep = "\t" , row.names = F)
```
...
write.table(peakanno_module2 , file = "~/zbf_scATAC_v3/to_do/todo2_decrease_module_2_annotation.bed" , quote = F , sep = "\t" , row.names = F)
```