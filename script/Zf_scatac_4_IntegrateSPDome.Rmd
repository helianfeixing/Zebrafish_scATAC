...
Idents(integrated_spdome) <- factor(integrated_spdome$type , levels = c("DEL1" , "DEL2" , "EVL" , "E-YSL"))
```
...
write.table(markers_spdome_evl_anno , quote = F , sep = "," , row.names = F , file = "~/zbf_scATAC_v3/to_do/todo5_markerpeak_evl.csv")
...
write.table(markers_spdome_DEL1_anno , quote = F , sep = "," , row.names = F , file = "~/zbf_scATAC_v3/to_do/todo5_markerpeak_DEL1.csv")
...
write.table(markers_spdome_DEL2_anno , quote = F , sep = "," , row.names = F , file = "~/zbf_scATAC_v3/to_do/todo5_markerpeak_DEL2.csv")
...
write.table(markers_spdome_ysl_anno , quote = F , sep = "," , row.names = F , file = "~/zbf_scATAC_v3/to_do/todo5_markerpeak_ysl.csv")
```